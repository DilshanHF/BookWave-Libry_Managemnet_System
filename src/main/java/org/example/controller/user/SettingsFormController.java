...
public class SettingsFormController {
    ...
    public void initializeUser() {
        try {
            ...
            /*userdto = userBOImpl.search(txtEmail.getText());

            txtUsername.setText(userdto.getName());
            txtTelephone.setText(String.valueOf(userdto.getTelephone()));
            cmbBranch.setPromptText(userdto.getBranch().getLocation());*/
